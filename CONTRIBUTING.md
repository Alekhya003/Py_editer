...
-  Fork this [repository](https://github.com/Alekhya003/Py_editer)
  
-  Clone the forked https://github.com/<Your_Username>/Py_editer
    > git clone https://github.com/<Your_Username>/Py_editer
...
- Add the upstream (main project's) repo's URL
    ...
    > git remote add upstream https://github.com/Alekhya003/Py_editer.git
